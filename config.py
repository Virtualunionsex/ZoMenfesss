...
bot_token = os.environ.get("BOT_TOKEN", "5836751708:AAFo6BGdTgxU-M1iHV56D5q8XMvkNKNg4rA")
# =========================================================== #
...
channel_2 = int(os.environ.get("CHANNEL_2", "-1001871325231"))
...
pesan_join = os.environ.get("PESAN_JOIN", "Tidak dapat diakses harap join terlebih dahulu, dan gunakan hastag #boy ataw #girl untuk mengirim menfess")
start_msg = os.environ.get("START_MSG", "Hai {fullname} 🌱\n\nIni adalah bot menfess area 69, semua pesan yang kamu kirim akan masuk ke channel secara anonymous, \n\nGunakan Hastag #boy ataw #girl untuk mengirim menfess. \n\nKetik /help info")
